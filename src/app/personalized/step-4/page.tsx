...
export default function PersonalizedStep4() {
	return (
		<div className="content-container personalized-step-container">
			<div className="title">Bạn không thích loại thực phẩm nào sau đây?</div>
			...
			<div className="button-container">
				...
				<Link href="/profile">
					<button className="button next-button">HOÀN THÀNH</button>
				</Link>
			</div>
		</div>
	);
